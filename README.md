# Relationship Extraction Ruby Sinatra Starter Application
...
[![Deploy to Bluemix](https://bluemix.net/deploy/button.png)](https://bluemix.net/deploy?repository=https://github.com/watson-developer-cloud/relationship-extraction-ruby)
